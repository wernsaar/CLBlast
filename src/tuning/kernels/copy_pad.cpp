...
class TunePad {
 public:
  ...
  static void SetParameters(cltune::Tuner &tuner, const size_t id) {
    tuner.AddParameter(id, "PAD_DIMX", {4, 8, 16, 32, 64});
    tuner.AddParameter(id, "PAD_DIMY", {4, 8, 16, 32, 64});
    tuner.AddParameter(id, "PAD_WPTX", {1, 2, 4, 8, 16});
    tuner.AddParameter(id, "PAD_WPTY", {1, 2, 4, 8, 16});
  }
