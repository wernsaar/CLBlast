...
const Database::DatabaseEntry Database::XgemmSingle = {
  "Xgemm", Precision::kSingle, {
	...
	{ "Oland_341",					     { {"MWG",128}, {"NWG",128}, {"KWG",16}, {"MDIMC",16}, {"NDIMC",16}, {"MDIMA",32}, {"NDIMB",32}, {"KWI",2}, {"VWM",4}, {"VWN",2}, {"STRM",0}, {"STRN",1}, {"SA",1}, {"SB",1} } },
	{ "Olandbak",					     { {"MWG",128}, {"NWG",128}, {"KWG",16}, {"MDIMC",16}, {"NDIMC",16}, {"MDIMA",32}, {"NDIMB",32}, {"KWI",2}, {"VWM",4}, {"VWN",2}, {"STRM",0}, {"STRN",1}, {"SA",1}, {"SB",1} } },
        { "Olandbak",                                        { {"MWG",64}, {"NWG",64}, {"KWG",8}, {"MDIMC",8}, {"NDIMC",16}, {"MDIMA",16}, {"NDIMB",16}, {"KWI",2}, {"VWM",4}, {"VWN",2}, {"STRM",0}, {"STRN",0}, {"SA",1}, {"SB",1}, {"PRECISION",32} } },
        { "Oland",                                           { {"MWG",128}, {"NWG",64}, {"KWG",16}, {"MDIMC",32}, {"NDIMC",8}, {"MDIMA",16}, {"NDIMB",16}, {"KWI",2}, {"VWM",4}, {"VWN",4}, {"STRM",1}, {"STRN",0}, {"SA",1}, {"SB",1}, {"PRECISION",32} } },
...
{ "AMD FX(tm)-8150 Eight-Core Processor", { {"MWG",128}, {"NWG",64}, {"KWG",16}, {"MDIMC",4}, {"NDIMC",4}, {"MDIMA",8}, {"NDIMB",4}, {"KWI",1}, {"VWM",4}, {"VWN",4}, {"STRM",0}, {"STRN",0}, {"SA",0}, {"SB",0}, {"PRECISION",32} } },
    ...
    { // Intel CPUs
      kDeviceTypeCPU, "Intel", {
        ...
        { "Intel(R) Core(TM) i5 CPU         750  @ 2.67GHz", { {"MWG",128}, {"NWG",128}, {"KWG",32}, {"MDIMC",8}, {"NDIMC",8}, {"MDIMA",8}, {"NDIMB",8}, {"KWI",2}, {"VWM",8}, {"VWN",4}, {"STRM",0}, {"STRN",0}, {"SA",1}, {"SB",1}, {"PRECISION",32} } },
        { "default",                                         { {"KWG",32}, {"KWI",2}, {"MDIMA",16}, {"MDIMC",8}, {"MWG",64}, {"NDIMB",8}, {"NDIMC",8}, {"NWG",64}, {"SA",0}, {"SB",1}, {"STRM",1}, {"STRN",0}, {"VWM",1}, {"VWN",2} } },
      }
    },
    { // Intel GPUs
    ...
    { // NVIDIA GPUs
      kDeviceTypeGPU, "NVIDIA", {
        ...
        { "GeForce GTX 750bak",                                 { {"MWG",64}, {"NWG",128}, {"KWG",16}, {"MDIMC",8}, {"NDIMC",16}, {"MDIMA",16}, {"NDIMB",16}, {"KWI",8}, {"VWM",4}, {"VWN",4}, {"STRM",1}, {"STRN",1}, {"SA",1}, {"SB",1}, {"PRECISION",32} } },
        { "GeForce GTX 750bak",                                 { {"MWG",64}, {"NWG",64}, {"KWG",8}, {"MDIMC",8}, {"NDIMC",8}, {"MDIMA",16}, {"NDIMB",16}, {"KWI",8}, {"VWM",4}, {"VWN",4}, {"STRM",1}, {"STRN",1}, {"SA",1}, {"SB",1}, {"PRECISION",32} } },
  ...
  "Xgemm", Precision::kComplexSingle, {
    { // AMD GPUs
      kDeviceTypeGPU, "AMD", {
        ...
        { "Olandbak1",                                       { {"MWG",64}, {"NWG",128}, {"KWG",32}, {"MDIMC",16}, {"NDIMC",16}, {"MDIMA",32}, {"NDIMB",32}, {"KWI",8}, {"VWM",2}, {"VWN",1}, {"STRM",1}, {"STRN",0}, {"SA",0}, {"SB",0}, {"PRECISION",3232} } },
        { "Olandbak2", 					     { {"MWG",64}, {"NWG",128}, {"KWG",64}, {"MDIMC",16}, {"NDIMC",16}, {"MDIMA",16}, {"NDIMB",16}, {"KWI",2}, {"VWM",2}, {"VWN",2}, {"STRM",1}, {"STRN",1}, {"SA",0}, {"SB",0}, {"PRECISION",3232} } },
       { "Olandbak3",                                        { {"MWG",64}, {"NWG",64}, {"KWG",16}, {"MDIMC",16}, {"NDIMC",8}, {"MDIMA",16}, {"NDIMB",8}, {"KWI",1}, {"VWM",4}, {"VWN",1}, {"STRM",0}, {"STRN",0}, {"SA",0}, {"SB",0}, {"PRECISION",3232} } },
       { "Olandbak",                                            { {"MWG",128}, {"NWG",64}, {"KWG",32}, {"MDIMC",32}, {"NDIMC",8}, {"MDIMA",16}, {"NDIMB",16}, {"KWI",2}, {"VWM",2}, {"VWN",1}, {"STRM",1}, {"STRN",0}, {"SA",0}, {"SB",0}, {"PRECISION",3232} } },
       { "Oland",                                            { {"MWG",128}, {"NWG",64}, {"KWG",8}, {"MDIMC",32}, {"NDIMC",8}, {"MDIMA",32}, {"NDIMB",32}, {"KWI",8}, {"VWM",2}, {"VWN",1}, {"STRM",0}, {"STRN",0}, {"SA",0}, {"SB",0}, {"PRECISION",3232} } },
    ...
    { // AMD CPUs
      kDeviceTypeCPU, "AMD", {
        ...
        { "AMD FX(tm)-8150 Eight-Core Processorbak6",        { {"MWG",128}, {"NWG",128}, {"KWG",16}, {"MDIMC",4}, {"NDIMC",16}, {"MDIMA",32}, {"NDIMB",4}, {"KWI",2}, {"VWM",1}, {"VWN",2}, {"STRM",0}, {"STRN",0}, {"SA",0}, {"SB",0}, {"PRECISION",3232} } },
        { "AMD FX(tm)-8150 Eight-Core Processor",            { {"MWG",128}, {"NWG",128}, {"KWG",8}, {"MDIMC",8}, {"NDIMC",8}, {"MDIMA",16}, {"NDIMB",16}, {"KWI",2}, {"VWM",1}, {"VWN",2}, {"STRM",0}, {"STRN",0}, {"SA",0}, {"SB",0}, {"PRECISION",3232} } },
    ...
    { // NVIDIA GPUs
      kDeviceTypeGPU, "NVIDIA", {
        ...
        { "GeForce GTX 750bak",                              { {"MWG",64}, {"NWG",128}, {"KWG",16}, {"MDIMC",16}, {"NDIMC",16}, {"MDIMA",16}, {"NDIMB",16}, {"KWI",2}, {"VWM",1}, {"VWN",2}, {"STRM",1}, {"STRN",1}, {"SA",1}, {"SB",1}, {"PRECISION",3232} } },
  ...
  "Xgemm", Precision::kDouble, {
    { // AMD GPUs
      kDeviceTypeGPU, "AMD", {
        ...
        { "Oland",                                           { {"MWG",64}, {"NWG",64}, {"KWG",16}, {"MDIMC",8}, {"NDIMC",16}, {"MDIMA",8}, {"NDIMB",8}, {"KWI",2}, {"VWM",4}, {"VWN",4}, {"STRM",0}, {"STRN",0}, {"SA",1}, {"SB",1} } },
    ...
    { // Intel CPUs
      kDeviceTypeCPU, "Intel", {
        ...
        { "Intel(R) Core(TM) i5 CPU         750  @ 2.67GHz", { {"MWG",128}, {"NWG",128}, {"KWG",16}, {"MDIMC",8}, {"NDIMC",8}, {"MDIMA",32}, {"NDIMB",16}, {"KWI",1}, {"VWM",1}, {"VWN",8}, {"STRM",0}, {"STRN",1}, {"SA",0}, {"SB",1}, {"PRECISION",64} } },
    ...
    { // NVIDIA GPUs
      kDeviceTypeGPU, "NVIDIA", {
        ...
        { "GeForce GTX 750",                                 { {"MWG",32}, {"NWG",128}, {"KWG",32}, {"MDIMC",16}, {"NDIMC",16}, {"MDIMA",16}, {"NDIMB",32}, {"KWI",2}, {"VWM",1}, {"VWN",1}, {"STRM",1}, {"STRN",0}, {"SA",0}, {"SB",0}, {"PRECISION",64} } },
        { "GeForce GTS 450",                                 { {"MWG",32}, {"NWG",64}, {"KWG",16}, {"MDIMC",8}, {"NDIMC",16}, {"MDIMA",8}, {"NDIMB",16}, {"KWI",8}, {"VWM",4}, {"VWN",4}, {"STRM",1}, {"STRN",0}, {"SA",1}, {"SB",1}, {"PRECISION",64} } },
  ...
  "Xgemm", Precision::kComplexDouble, {
    ...
    { // Intel CPUs
      kDeviceTypeCPU, "Intel", {
        ...
        { "Intel(R) Core(TM) i5 CPU         750  @ 2.67GHz", { {"MWG",128}, {"NWG",128}, {"KWG",16}, {"MDIMC",8}, {"NDIMC",8}, {"MDIMA",16}, {"NDIMB",8}, {"KWI",1}, {"VWM",1}, {"VWN",2}, {"STRM",0}, {"STRN",0}, {"SA",0}, {"SB",1}, {"PRECISION",6464} } },
    ...
    { // NVIDIA GPUs
      kDeviceTypeGPU, "NVIDIA", {
        ...
        { "GeForce GTX 750",                                 { {"MWG",16}, {"NWG",128}, {"KWG",32}, {"MDIMC",16}, {"NDIMC",8}, {"MDIMA",8}, {"NDIMB",8}, {"KWI",8}, {"VWM",1}, {"VWN",4}, {"STRM",0}, {"STRN",0}, {"SA",0}, {"SB",0}, {"PRECISION",6464} } },
        { "GeForce GTS 450",                                 { {"MWG",16}, {"NWG",32}, {"KWG",16}, {"MDIMC",16}, {"NDIMC",8}, {"MDIMA",16}, {"NDIMB",32}, {"KWI",8}, {"VWM",1}, {"VWN",1}, {"STRM",1}, {"STRN",1}, {"SA",1}, {"SB",1}, {"PRECISION",6464} } },
        { "default",                                         { {"KWG",16}, {"KWI",2}, {"MDIMA",8}, {"MDIMC",8}, {"MWG",16}, {"NDIMB",8}, {"NDIMC",8}, {"NWG",32}, {"SA",0}, {"SB",0}, {"STRM",0}, {"STRN",0}, {"VWM",1}, {"VWN",1} } },
      }
    },
    { // Default
