  ...
  "Copy", Precision::kSingle, {
    ...
    { // AMD CPUs
      kDeviceTypeCPU, "AMD", {
        ...
        { "AMD FX(tm)-8150 Eight-Core Processor",            { {"COPY_DIMX",64}, {"COPY_DIMY",8}, {"COPY_WPT",2}, {"COPY_VW",16}, {"PRECISION",32} } },
        { "default",                                         { {"COPY_DIMX",8},  {"COPY_DIMY",8},  {"COPY_VW",2},  {"COPY_WPT",1} } },
      }
    },
    { // ARM GPUs
  ...
  "Copy", Precision::kComplexSingle, {
    ...
    { // AMD CPUs
      kDeviceTypeCPU, "AMD", {
        ...
        { "AMD FX(tm)-8150 Eight-Core Processor",            { {"COPY_DIMX",64}, {"COPY_DIMY",4}, {"COPY_WPT",1}, {"COPY_VW",16}, {"PRECISION",3232} } },
  ...
  "Copy", Precision::kComplexDouble, {
    ...
    { // AMD CPUs
      kDeviceTypeCPU, "AMD", {
        ...
        { "AMD FX(tm)-8150 Eight-Core Processor",            { {"COPY_DIMX",64}, {"COPY_DIMY",4}, {"COPY_WPT",8}, {"COPY_VW",16}, {"PRECISION",6464} } },
